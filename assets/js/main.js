...
$(window).load(function(){
    ...
    jQuery(document).on('ready', function () {
        ...
        jQuery(window).on('scroll', function (event) {
            ...
            if (scroll < 150) {
                jQuery(".spotmies-sticky").removeClass("sticky");
            } else {
                jQuery(".spotmies-sticky").addClass("sticky");
            }
        });


        //===== spotmies team slick slider
        $('.spotmies-testimonial-slider').slick({
            dots: true,
            infinite: true,
            autoplay: true,
            autoplaySpeed: 2000,
        ...
        //===== spotmies team slick slider
        $('.spotmies-testimonial-slider-rtl').slick({
            dots: true,
            infinite: true,
            autoplay: true,
            autoplaySpeed: 2000,
        ...
        //===== spotmies team slick slider
        $('.spotmies-testimonial-slider-2').slick({
            dots: false,
            infinite: true,
            autoplay: true,
            autoplaySpeed: 2000,
        ...
        //===== spotmies VIDEO PLAYER slick slider
        $('.spotmies-video-player-slider').slick({
            dots: false,
            infinite: true,
            autoplay: true,
            autoplaySpeed: 2000,
        ...
        //===== spotmies VIDEO PLAYER slick slider
        $('.spotmies-showcase-slider').slick({
            dots: true,
            infinite: true,
            autoplay: true,
            autoplaySpeed: 2000,
       ...
       //===== pricing plan js active
        ...
        jQuery('.spotmies-video-popup').magnificPopup({
            type: 'iframe'
            // other options
        });
        ...
        jQuery('.spotmies-image-popup').magnificPopup({
            type: 'image',
            gallery: {
                enabled: true
            }
